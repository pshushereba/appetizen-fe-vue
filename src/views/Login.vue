<template>
  <div>
    <section
      class="flex flex-col items-center h-screen bg-blueGray-100 md:flex-row "
    >
      <div
        class="relative hidden w-full h-screen bg-blueGray-400 lg:block md:w-1/3 lg:w-2/3"
      >
        <img
          src="https://dummyimage.com/600x500/F3F4F7/000000"
          alt=""
          ...
          <form class="mt-6" action="#" method="POST">
            <div>
              ...
              <input
                ...
                class="w-full px-4 py-2 mt-2 text-base transition duration-500 ease-in-out transform border-transparent rounded-lg bg-blueGray-100 ext-black-700 focus:border-blueGray-500 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2"
              />
            </div>
            <div class="mt-4">
              <label
              ...
              <input
                ...
                minlength="6"
                class="w-full px-4 py-2 text-base transition duration-500 ease-in-out transform border-transparent rounded-lg bg-blueGray-100 ext-black-700 focus:border-blueGray-500 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2"
                required=""
              />
            </div>
