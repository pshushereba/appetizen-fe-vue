        ...
        <nav class="relative max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6" aria-label="Global">
          <div class="flex items-center flex-1">
            ...
            <div class="hidden space-x-8 md:flex md:ml-10">
              <router-link to="/" class="text-base font-medium text-white hover:text-gray-300">Appetizen</router-link>
              <router-link to="/pricing" class="text-base font-medium text-white hover:text-gray-300">Pricing</router-link>

              <router-link to="/about" class="text-base font-medium text-white hover:text-gray-300">About</router-link>

              <router-link to="/contact" class="text-base font-medium text-white hover:text-gray-300">Contact</router-link>

              <router-link href="" class="text-base font-medium text-white hover:text-gray-300">Company</router-link>
            </div>
          </div>
